...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('trainer.program-builder.show', $program->id) }}" class="btn btn-secondary me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('trainer.program-videos.edit', [$program->id, $video->id]) }}" class="btn btn-outline-primary" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form method="POST" action="{{ route('trainer.program-videos.destroy', [$program->id, $video->id]) }}" class="d-inline" onsubmit="return confirm('Delete this video?');">
                                        @csrf
                                        @method('DELETE')
