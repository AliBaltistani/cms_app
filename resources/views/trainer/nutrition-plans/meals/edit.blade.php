...
<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <div>
        <h1 class="page-title fw-semibold fs-18 mb-0">Edit Meal</h1>
        <div class="">
            <nav>
    ...
    <div class="col-xl-12">
        <div class="alert alert-info" role="alert">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <strong>Editing meal in:</strong> {{ $plan->plan_name }}
                    @if($plan->client)
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" placeholder="Enter meal title" value="{{ old('title', $meal->title) }}" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-12 mb-3">
                            <label for="description" class="form-label">Description</label>
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter meal description">{{ old('description', $meal->description) }}</textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-6 mb-3">
                            ...
                            <select class="form-select" id="meal_type" name="meal_type" required>
                                ...
                                <option value="pre_workout" {{ old('meal_type', $meal->meal_type) == 'pre_workout' ? 'selected' : '' }}>Pre-Workout</option>
                                <option value="post_workout" {{ old('meal_type', $meal->meal_type) == 'post_workout' ? 'selected' : '' }}>Post-Workout</option>
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label for="servings" class="form-label">Servings <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="servings" name="servings" placeholder="Number of servings" min="1" max="20" value="{{ old('servings', $meal->servings) }}" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label for="prep_time" class="form-label">Prep Time (minutes)</label>
                            <input type="number" class="form-control" id="prep_time" name="prep_time" placeholder="Preparation time" min="0" max="480" value="{{ old('prep_time', $meal->prep_time) }}">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-6 mb-3">
                            <label for="cook_time" class="form-label">Cook Time (minutes)</label>
                            <input type="number" class="form-control" id="cook_time" name="cook_time" placeholder="Cooking time" min="0" max="480" value="{{ old('cook_time', $meal->cook_time) }}">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="calories_per_serving" name="calories_per_serving" placeholder="Calories per serving" min="0" max="2000" step="1" value="{{ old('calories_per_serving', $meal->calories_per_serving) }}">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-xl-6 mb-3">
        ...
        <div class="col-xl-4">
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    @if($meal->image_url)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $meal->image_url) }}" alt="{{ $meal->title }}" class="img-fluid rounded" style="max-height: 200px; width: 100%; object-fit: cover;">
                            <div class="mt-2">
                    ...
                    @endif
                    <div class="mb-3">
                        <label for="image_file" class="form-label">{{ $meal->image_url ? 'Replace Image' : 'Upload Image' }}</label>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', $meal->sort_order) }}" min="0" required>
                        <div class="invalid-feedback"></div>
                    ...
                    <div class="row text-center">
                        <div class="col-6 mb-2">
                            <div class="border rounded p-2">
                                <h6 class="mb-0">{{ $meal->calories_per_serving ?? 0 }}</h6>
