...
class StoreWorkoutVideoRequest extends FormRequest
{
    ...
    {
        return true; // Allow authenticated users to create workout videos
    }
    ...
    public function rules(): array
    {
        ...
        if ($this->video_type === 'file') {
            $rules['video_file'] = 'required|file|mimes:mp4,avi,mov,wmv,flv,webm,mkv|max:102400'; // Max 100MB
    ...
    public function messages(): array
    {
        return [
            ...
            'video_file.required' => 'Video file is required when upload type is selected.',
